...
public class TitleView extends LinearLayout implements OnClickListener {
    ...
    private void readAttrs(Context context, AttributeSet attrs) {
        ...
        for (int i = 0; i < count; ++i) {
            ...
            switch (attr) {
                case R.styleable.TitleView_leftIbtn:
                    ...
                    break;
                case R.styleable.TitleView_rightIbtn:
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.tv_left_titleView:
                if (mClickListener != null) {
                    mClickListener.onLeftClick(v);
                }
                break;
            case R.id.ibtn_left_titleView:
                if (mClickListener != null) {
                    mClickListener.onLeftClick(v);
                }
                break;
            case R.id.tv_right_titleView:
                if (mClickListener != null) {
                    mClickListener.onRightClick(v);
                }
                break;
            case R.id.ibtn_right_titleView:
                if (mClickListener != null) {
                    mClickListener.onRightClick(v);
                }
                break;
